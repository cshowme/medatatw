...
(function($) { $("#35d4bbc6c295dd35ea0412ad067ddf1e").iv_widget({ values: "D%2BZMnZRnfxSrPcmWkBwLd%2FMD0oq%2BChvE62JWRzCR7yKEFDrVYT84Df5rR7WaDGCz5r4HMeJ82NlVS%2BSyLv%2B%2FuliGWNfJTE1Yp0IiJkicT6PEv2mbxqy2ZlGMa1qUan0B82DvqPLEe%2FPjq0PgLBgwtszWUm2Q%2FocZhTb%2BWRB88m2klosx%2F3x3OkrtYbjxoy1LkfEzxSTxnvW3Iyy2DYol4Cqvh6ExXG1RAD%2B4rYhUjo4YCZFjdREIgz4GDEttuaGRA7kW8dmA3AsWsOsLy9rrALOReEL9oWqSZl%2BoOFGqXjy5LzZhy7Ost6QFytRcddooa%2B28QR%2FUeX1%2FsxhXJ%2Fr842AwE59VjSHvcbShwKgnFbEGoDQKUeGqNZD%2Fh1t21XqxVcwShd1GP39FrI2CCg%3D%3D", no_parent: false }); })(jQuery);
      jQuery("#slick_index_20950").slick({      galleryType: 'carousel',      lazyLoad: 'ondemand',      dots: true,      infinite: true,      slidesToShow: 2,      slidesToScroll: 1,      autoplay: false,      autoplaySpeed: 3000,      centerMode: false,      respondsTo: 'slider',      centerPadding: '20px',responsive: [{        breakpoint: 1001,        settings: {                      galleryType: 'carousel',                      arrows: true,                      centerMode: false,                      centerPadding: '0px',                      slidesToShow: 3,                      slidesToScroll: 3,                      infinite: true,                      dots: true                    }},{        breakpoint: 771,        settings: {                      galleryType: 'carousel',                      arrows: true,                      centerMode: false,                      centerPadding: '0px',                      slidesToShow: 2,                      slidesToScroll: 2,                      infinite: true,                      dots: true                    }},{        breakpoint: 501,        settings: {                      galleryType: 'carousel',                      arrows: false,                      centerMode: false,                      centerPadding: '0px',                      slidesToShow: 1,                      slidesToScroll: 1,                      infinite: true,                      dots: false                    }}]}); 
jQuery("#slick_index_20950").slick('slickPlay'); 
jQuery("#slick_index_20950 img").each(function(){      jQuery(this).captionjs({ mode : "animated" });    }); 
jQuery("#slick_index_20950 figure").each(function(){      jQuery(this).css("width","100%");    }); 
      jQuery("#slick_index_26108").slick({      galleryType: 'grid',      lazyLoad: 'ondemand',      dots: true,      infinite: true,      rows: 1,      slidesPerRow: 1,      slidesToScroll: 1,      autoplay: false,      autoplaySpeed: 3000,      centerMode: false,      respondsTo: 'slider',      centerPadding: '0px',responsive: [{        breakpoint: 1001,        settings: {                      galleryType: 'grid',                      arrows: true,                      centerMode: false,                      centerPadding: '0px',                      rows: 2,                      slidesPerRow: 2,                      slidesToScroll: 1,                      infinite: true,                      dots: true                    }},{        breakpoint: 771,        settings: {                      galleryType: 'grid',                      arrows: true,                      centerMode: false,                      centerPadding: '0px',                      rows: 2,                      slidesPerRow: 1,                      slidesToScroll: 1,                      infinite: true,                      dots: true                    }},{        breakpoint: 501,        settings: {                      galleryType: 'grid',                      arrows: false,                      centerMode: false,                      centerPadding: '0px',                      rows: 1,                      slidesPerRow: 1,                      slidesToScroll: 1,                      infinite: true,                      dots: false                    }}]});

jQuery("#slick_index_26108").slick('slickPlay'); 

jQuery("#slick_index_26108 img").each(function(){      jQuery(this).captionjs({ mode : "animated" });    }); 
jQuery("#slick_index_26108 figure").each(function(){      jQuery(this).css("width","100%");    }); 
jQuery("#slick_index_26108").magnificPopup({        delegate: '.slick-slide:not(.slick-cloned) span',        type: 'image',        prependTo: jQuery("#grid2_26108"),        closeOnContentClick: true,        closeBtnInside: false,image: {        titleSrc: function(item) {            return item.el.attr('data-description');        }      },callbacks: {          close: function() {            jQuery("#slick_index_26108").slick('slickPlay');          },          open: function() {            jQuery("#slick_index_26108").slick('slickPause');          }      },gallery: { enabled:true, tCounter: '<span class="mfp-counter"><nobr>%curr%/4</nobr></span>' }        });
...
jQuery("#rot_ctr1_bod_ctr1").ivfx_pin({"class":"ivfx_pin","breakpoints":[0,1000,770,499],"breakpoint_params":{"0":{"width":"0","is_enabled":1,"params":{},"name":"desktop"},"1000":{"width":"1000","is_enabled":1,"params":{},"name":"tablet"},"770":{"name":"phablet","params":{},"is_enabled":1,"width":"770"},"499":{"name":"phone","params":{},"is_enabled":1,"width":"499"}}})


jQuery("#rot_ctr1_bod_ctr2_bod_wrp1").ivfx_background_parallax({"class":"ivfx_background_parallax","breakpoint_params":{"770":{"width":"770","is_enabled":0,"params":{},"name":"phablet"},"499":{"name":"phone","params":{},"width":"499","is_enabled":0},"1000":{"name":"tablet","is_enabled":1,"width":"1000","params":{}},"0":{"name":"desktop","params":{},"width":"0","is_enabled":1}},"breakpoints":[0,1000,770,499]})
