...
(function($) { $("#35d4bbc6c295dd35ea0412ad067ddf1e").iv_widget({ values: "D%2BZHgqRpeymmMNjViEgFOXzGLEOIld3HrVoYWKuhWehPu%2BMk6flQkZ5q2i7CwQaZ6dPPV4oELl%2B%2Fi02wQrMwMN80vOxJZBMf1ZDHJWGh55qLj%2F7w2omyIObdrWblkNjP19U4THtaOGNbLsxOS8aw%2BhPYCwprNECqXseqrK61v4l79Y9vfZbRvhJlpebGDfSdxB8dLHfAJDB4UW%2BQihwkOdcvwSFYp3XlMEwUFJfpUZw9q4IY8EDWSUZEGNS43fXoW9LSxYoZn87%2FXm2awh5UkcOLceWBexFp5OOfgTB13XKaZzyu3hm%2B3iZsPLmrUORH6CSM5pIBg48k%2Bn3i19qnohYS93JaQ7DevZFciCwfGi%2B3F8zKM%2BtdoOAT92yp%2FqyeokKvFm7ZML4tS1OY0g%3D%3D", no_parent: false }); })(jQuery);

      jQuery("#slick_index_26082").slick({      galleryType: 'grid',      lazyLoad: 'ondemand',      dots: true,      infinite: true,      rows: 1,      slidesPerRow: 2,      slidesToScroll: 1,      autoplay: false,      autoplaySpeed: 3000,      centerMode: false,      respondsTo: 'slider',      centerPadding: '0px'});

jQuery("#slick_index_26082").slick('slickPlay'); 

jQuery("#slick_index_26082 img").each(function(){      jQuery(this).captionjs({ mode : "animated" });    }); 
jQuery("#slick_index_26082 figure").each(function(){      jQuery(this).css("width","100%");    }); 

      jQuery("#slick_index_28284").slick({      galleryType: 'grid',      lazyLoad: 'ondemand',      dots: true,      infinite: true,      rows: 1,      slidesPerRow: 2,      slidesToScroll: 1,      autoplay: false,      autoplaySpeed: 3000,      centerMode: false,      respondsTo: 'slider',      centerPadding: '0px'});

jQuery("#slick_index_28284").slick('slickPlay'); 

jQuery("#slick_index_28284 img").each(function(){      jQuery(this).captionjs({ mode : "animated" });    }); 
jQuery("#slick_index_28284 figure").each(function(){      jQuery(this).css("width","100%");    }); 

      jQuery("#slick_index_26083").slick({      galleryType: 'grid',      lazyLoad: 'ondemand',      dots: true,      infinite: true,      rows: 1,      slidesPerRow: 2,      slidesToScroll: 1,      autoplay: false,      autoplaySpeed: 3000,      centerMode: false,      respondsTo: 'slider',      centerPadding: '0px',responsive: [{        breakpoint: 1001,        settings: {                      galleryType: 'grid',                      arrows: true,                      centerMode: false,                      centerPadding: '0px',                      rows: 2,                      slidesPerRow: 2,                      slidesToScroll: 1,                      infinite: true,                      dots: true                    }},{        breakpoint: 771,        settings: {                      galleryType: 'grid',                      arrows: true,                      centerMode: false,                      centerPadding: '0px',                      rows: 2,                      slidesPerRow: 1,                      slidesToScroll: 1,                      infinite: true,                      dots: true                    }},{        breakpoint: 501,        settings: {                      galleryType: 'grid',                      arrows: true,                      centerMode: false,                      centerPadding: '0px',                      rows: 1,                      slidesPerRow: 1,                      slidesToScroll: 1,                      infinite: true,                      dots: false                    }}]});

jQuery("#slick_index_26083").slick('slickPlay'); 

jQuery("#slick_index_26083 img").each(function(){      jQuery(this).captionjs({ mode : "animated" });    }); 
jQuery("#slick_index_26083 figure").each(function(){      jQuery(this).css("width","100%");    }); 
...
jQuery("#rot_ctr1_bod_ctr1").ivfx_pin({"class":"ivfx_pin","breakpoint_params":{"1000":{"params":{},"width":"1000","is_enabled":1,"name":"tablet"},"770":{"width":"770","is_enabled":1,"params":{},"name":"phablet"},"499":{"name":"phone","is_enabled":1,"width":"499","params":{}},"0":{"name":"desktop","params":{},"width":"0","is_enabled":1}},"breakpoints":[0,1000,770,499]})


jQuery("#rot_ctr1_bod_ctr2_bod_wrp1").ivfx_background_parallax({"breakpoint_params":{"0":{"name":"desktop","width":"0","is_enabled":1,"params":{}},"770":{"name":"phablet","params":{},"width":"770","is_enabled":0},"499":{"name":"phone","params":{},"is_enabled":0,"width":"499"},"1000":{"name":"tablet","is_enabled":1,"width":"1000","params":{}}},"breakpoints":[0,1000,770,499],"class":"ivfx_background_parallax"})
