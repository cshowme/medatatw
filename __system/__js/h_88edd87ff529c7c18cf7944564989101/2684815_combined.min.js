...
(function($) { $("#35d4bbc6c295dd35ea0412ad067ddf1e").iv_widget({ values: "D%2BZRl7tvMkzgPcXCz1BSOV52vI%2F8qRdQALeec5Us3KrDvKz4qJfU18EG6ERkKYAaYRBWXa9VpSBc6OcN7Bbt7q%2FTxCU%2FrSqYsad5pfE8uSr7NxVSxIA7Xr20C3igGvgNGeGcZ2LNxsH8emY8fKZKJuHoRMfyXlEw0LJ24ybi7tRkFlnHqMZAOsvansUM2BYt7gloGaFUsq%2Bbpsx5TMAbV3k0zRD9%2B%2FWkvCba6VNt4s7lTeY7RG2mkf1D9J%2Fo2Vu7k93UBXP594zgci2l%2BxpkFV3x2IsjnD%2BntDMEXIIl4roB0%2BxUf6a6%2FAw7C8nzHs90ZWrE5IPxnKHO3YSNeH9Jaj3iZmwt1WvRAEhsZpykbxnDijSKN54SNzr1GqyPqoUfQt8Egkg%2FlEzLSH%2B%2BqA%3D%3D", no_parent: false }); })(jQuery);

      jQuery("#slick_index_26079").slick({      galleryType: 'grid',      lazyLoad: 'ondemand',      dots: true,      infinite: true,      rows: 1,      slidesPerRow: 1,      slidesToScroll: 1,      autoplay: false,      autoplaySpeed: 3000,      centerMode: false,      respondsTo: 'slider',      centerPadding: '0px',responsive: [{        breakpoint: 1001,        settings: {                      galleryType: 'grid',                      arrows: true,                      centerMode: false,                      centerPadding: '0px',                      rows: 2,                      slidesPerRow: 2,                      slidesToScroll: 1,                      infinite: true,                      dots: true                    }},{        breakpoint: 771,        settings: {                      galleryType: 'grid',                      arrows: true,                      centerMode: false,                      centerPadding: '0px',                      rows: 2,                      slidesPerRow: 1,                      slidesToScroll: 1,                      infinite: true,                      dots: true                    }},{        breakpoint: 501,        settings: {                      galleryType: 'grid',                      arrows: true,                      centerMode: false,                      centerPadding: '0px',                      rows: 1,                      slidesPerRow: 1,                      slidesToScroll: 1,                      infinite: true,                      dots: false                    }}]});

jQuery("#slick_index_26079").slick('slickPlay'); 

jQuery("#slick_index_26079 img").each(function(){      jQuery(this).captionjs({ mode : "animated" });    }); 
jQuery("#slick_index_26079 figure").each(function(){      jQuery(this).css("width","100%");    }); 
jQuery("#slick_index_26079").magnificPopup({        delegate: '.slick-slide:not(.slick-cloned) span',        type: 'image',        prependTo: jQuery("#grid2_26079"),        closeOnContentClick: true,        closeBtnInside: false,image: {        titleSrc: function(item) {            return item.el.attr('data-description');        }      },callbacks: {          close: function() {            jQuery("#slick_index_26079").slick('slickPlay');          },          open: function() {            jQuery("#slick_index_26079").slick('slickPause');          }      },gallery: { enabled:true, tCounter: '<span class="mfp-counter"><nobr>%curr%/5</nobr></span>' }        });
...
jQuery("#rot_ctr1_bod_ctr1_bod").ivfx_pin({"breakpoints":[0,1000,770,499],"breakpoint_params":{"1000":{"name":"tablet","is_enabled":0,"width":"1000","params":{}},"499":{"params":{},"is_enabled":0,"width":"499","name":"phone"},"770":{"name":"phablet","is_enabled":0,"width":"770","params":{}},"0":{"params":{},"is_enabled":0,"width":"0","name":"desktop"}},"class":"ivfx_pin"})

jQuery("#rot_ctr1_bod_ctr1").ivfx_pin({"class":"ivfx_pin","breakpoint_params":{"1000":{"name":"tablet","width":"1000","is_enabled":1,"params":{}},"499":{"name":"phone","is_enabled":1,"width":"499","params":{}},"770":{"is_enabled":1,"width":"770","params":{},"name":"phablet"},"0":{"params":{},"width":"0","is_enabled":1,"name":"desktop"}},"breakpoints":[0,1000,770,499]})


jQuery("#rot_ctr1_bod_ctr2_bod_wrp1").ivfx_background_parallax({"breakpoints":[0,1000,770,499],"breakpoint_params":{"0":{"params":{},"is_enabled":1,"width":"0","name":"desktop"},"770":{"width":"770","is_enabled":0,"params":{},"name":"phablet"},"499":{"name":"phone","is_enabled":0,"width":"499","params":{}},"1000":{"name":"tablet","is_enabled":1,"width":"1000","params":{}}},"class":"ivfx_background_parallax"})
