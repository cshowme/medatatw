...
(function($) { $("#35d4bbc6c295dd35ea0412ad067ddf1e").iv_widget({ values: "D%2BZMnZRnfxSrPcmWkBwLd%2FMD0oq%2BChvE62JWRzCR7yKEFDrVYT84Df5rR7WaDGCz5r4HMeJ82MlNT%2BDPfeC%2F9HDiQ7S7dohvGxV5yqXh4C%2BlbtWzt%2FgLcYp5eQJNd6UWDIPcMGK%2FgDTwEaL6p945hwKYUuLjZnaIMVXW73CaiAGLrwg5cboVZTFUxSCBcieW%2BrbCBE1Psd4zhmAVqtrOPyNW3lmgOEDT%2Bx7fVXWjZ8%2BZvQPWMTrvl9HO7l4Aa%2BQ9kn8YOC7g0%2F7bylD4nryo47NkMW121VhwhsRz4ALQo%2FL5%2Fs4U%2BBBW4Fh9uG%2BXk8s3s7OTlQt0eMf1TJ0SaAVn26%2Fn1yrjPF0m8rYXLCdvWEEq1p3ERuFw93qLvcvE116XbJjRmeLKdHQWjqelqg%3D%3D", no_parent: false }); })(jQuery);
      jQuery("#slick_index_22820").slick({      galleryType: 'carousel',      lazyLoad: 'ondemand',      dots: true,      infinite: true,      slidesToShow: 2,      slidesToScroll: 2,      autoplay: false,      autoplaySpeed: 5000,      centerMode: false,      respondsTo: 'slider',      centerPadding: '60px',responsive: [{        breakpoint: 1001,        settings: {                      galleryType: 'carousel',                      arrows: true,                      centerMode: false,                      centerPadding: '0px',                      slidesToShow: 3,                      slidesToScroll: 3,                      infinite: true,                      dots: true                    }},{        breakpoint: 771,        settings: {                      galleryType: 'carousel',                      arrows: true,                      centerMode: false,                      centerPadding: '0px',                      slidesToShow: 2,                      slidesToScroll: 2,                      infinite: true,                      dots: true                    }},{        breakpoint: 501,        settings: {                      galleryType: 'carousel',                      arrows: false,                      centerMode: false,                      centerPadding: '0px',                      slidesToShow: 1,                      slidesToScroll: 1,                      infinite: true,                      dots: false                    }}]}); 
jQuery("#slick_index_22820").slick('slickPlay'); 
jQuery("#slick_index_22820 img").each(function(){      jQuery(this).captionjs({ mode : "animated" });    }); 
jQuery("#slick_index_22820 figure").each(function(){      jQuery(this).css("width","100%");    }); 
...
jQuery("#rot_ctr1_bod_ctr1").ivfx_pin({"class":"ivfx_pin","breakpoint_params":{"1000":{"width":"1000","is_enabled":0,"params":{},"name":"tablet"},"499":{"params":{},"is_enabled":0,"width":"499","name":"phone"},"770":{"is_enabled":0,"width":"770","params":{},"name":"phablet"},"0":{"is_enabled":0,"width":"0","params":{},"name":"desktop"}},"breakpoints":[0,1000,770,499]})

jQuery("#rot_ctr1_bod_ctr2_bod_wrp1").ivfx_background_parallax({"class":"ivfx_background_parallax","breakpoint_params":{"499":{"is_enabled":0,"width":"499","params":{},"name":"phone"},"770":{"is_enabled":0,"width":"770","params":{},"name":"phablet"},"1000":{"name":"tablet","params":{},"is_enabled":1,"width":"1000"},"0":{"name":"desktop","params":{},"width":"0","is_enabled":1}},"breakpoints":[0,1000,770,499]})
