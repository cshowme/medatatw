...
(function($) { $("#35d4bbc6c295dd35ea0412ad067ddf1e").iv_widget({ values: "D%2BZSi6l5eQKnDsXQiEhMLJaTmggQrxc42ktE8Ix8mvIH5o2gSyIzol44qsWOTbSNZsB0jUFtie4UOs%2BLmhWwSt2BoZtFr1daNN5N4Mk0NMLKWbLYiscV4huQOr7vh4ZhWJ5licOpdZ%2BxNiRxbsfiNsnCel3A%2F4oxtAXDvVYXe1biBR8s2N2WVmP2ELUyOzqm6t0FzOIujVk8K6iMn9PeWesmJ126nGI5O17NZ3gxfjyxjBstU3j9N3SZ21vKkSUkUcZwWeMZoh8QJfLKwBtHnKzhGGHsuYJsaVcgb0b7Qsb1CoEornmxaboQmDNVmcWQZE8Z2wQ6syVOxVvUBO5KD8LnBD%2BTuQJvSArEkfxTArkwdK%2FQKYrLU0BFRG4Uilg7uipm4%2BF5Hw2U7rdMcg%3D%3D", no_parent: false }); })(jQuery);

      jQuery("#slick_index_31227").slick({      galleryType: 'grid',      lazyLoad: 'ondemand',      dots: true,      infinite: true,      rows: 1,      slidesPerRow: 2,      slidesToScroll: 1,      autoplay: false,      autoplaySpeed: 3000,      centerMode: false,      respondsTo: 'slider',      centerPadding: '0px',responsive: [{        breakpoint: 1001,        settings: {                      galleryType: 'grid',                      arrows: true,                      centerMode: false,                      centerPadding: '0px',                      rows: 2,                      slidesPerRow: 2,                      slidesToScroll: 1,                      infinite: true,                      dots: true                    }},{        breakpoint: 771,        settings: {                      galleryType: 'grid',                      arrows: true,                      centerMode: false,                      centerPadding: '0px',                      rows: 2,                      slidesPerRow: 1,                      slidesToScroll: 1,                      infinite: true,                      dots: true                    }},{        breakpoint: 501,        settings: {                      galleryType: 'grid',                      arrows: true,                      centerMode: false,                      centerPadding: '0px',                      rows: 1,                      slidesPerRow: 1,                      slidesToScroll: 1,                      infinite: true,                      dots: false                    }}]});

jQuery("#slick_index_31227").slick('slickPlay'); 

jQuery("#slick_index_31227 img").each(function(){      jQuery(this).captionjs({ mode : "animated" });    }); 
jQuery("#slick_index_31227 figure").each(function(){      jQuery(this).css("width","100%");    }); 
...
jQuery("#rot_ctr1_bod_ctr1").ivfx_pin({"class":"ivfx_pin","breakpoint_params":{"0":{"name":"desktop","width":"0","is_enabled":1,"params":{}},"770":{"width":"770","is_enabled":1,"params":{},"name":"phablet"},"499":{"name":"phone","width":"499","is_enabled":1,"params":{}},"1000":{"name":"tablet","params":{},"is_enabled":1,"width":"1000"}},"breakpoints":[0,1000,770,499]})


jQuery("#rot_ctr1_bod_ctr2_bod_wrp1").ivfx_background_parallax({"class":"ivfx_background_parallax","breakpoints":[0,1000,770,499],"breakpoint_params":{"0":{"width":"0","is_enabled":1,"params":{},"name":"desktop"},"1000":{"name":"tablet","params":{},"is_enabled":1,"width":"1000"},"770":{"is_enabled":0,"width":"770","params":{},"name":"phablet"},"499":{"params":{},"is_enabled":0,"width":"499","name":"phone"}}})
